...
interface NoteCardProps {
  ...
  isEditable?: boolean; // Propiedad opcional para indicar si la tarjeta es editable
}
...
const NoteCard = ({
  ...
  // Toggle expand/collapse for the note card
  ...
  return (
    ...
    >
      ...
      <div className="w-full flex justify-end items-center space-x-2">
        {/* Show the delete button only if the note is editable */}
        {isEditable && !isEditing && !note.isCreating && (
          <button
